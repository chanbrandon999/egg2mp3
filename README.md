...
2. Change the "FINAL_DIR" variable to the location of where you want the output mp3 files to be stored. Beware of large folder depths! Beat saber filenames can be long. Note there may need to be a double slash "\\\\" to actually have a slash in the string.
